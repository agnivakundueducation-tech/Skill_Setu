      ...
      >
        ...
        <div className="p-3 border-b border-slate-100 dark:border-slate-800/80">
          ...
          >
            ...
            {!isCollapsed && (
              <RefreshCw className="w-3.5 h-3.5 opacity-60 group-hover:opacity-100 group-hover:rotate-180 transition-all shrink-0" />
            )}
          </button>
        </div>
                ...
                <>
                  <DynamicIcon
                    ...
                    className={`w-4 h-4 shrink-0 ${
                      isActive ? 'text-white' : 'text-slate-500 dark:text-slate-400 group-hover:text-current'
                    }`}
                  />
                  {!isCollapsed && (
