...
export const CollaborationCard: React.FC<CollaborationCardProps> = ({
  ...
  const getTypeBadge = (type: string) => {
    switch (type) {
      ...
      case 'Mentorship':
        return <Badge variant="cyan" size="sm">Mentorship</Badge>;
      case 'Innovation Challenge':
        return <Badge variant="rose" size="sm">Innovation Challenge</Badge>;
      case 'Industrial Training':
        return <Badge variant="teal" size="sm">Industrial Training</Badge>;
      default:
