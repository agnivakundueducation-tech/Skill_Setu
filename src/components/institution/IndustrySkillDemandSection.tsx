          ...
          <div className="space-y-2 max-h-64 overflow-y-auto pr-1">
            {skillDemands.slice(0, 6).map((skill, idx) => {
              ...
              return (
                <div
                  key={skill.skillId}
                  className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/70 border border-slate-200/70 dark:border-slate-700/80 flex items-center justify-between text-xs hover:border-indigo-400 dark:hover:border-indigo-500 transition-colors"
                >
          ...
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60">
              {demandVsReadinessList.map((item) => (
                <tr key={item.skillId} className="hover:bg-slate-50/70 dark:hover:bg-slate-800/50 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {recommendations.map((rec) => (
            ...
            >
              ...
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200/60 dark:border-slate-700/70 text-xs space-y-1.5">
