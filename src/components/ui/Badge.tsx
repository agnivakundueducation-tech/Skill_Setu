...
export type BadgeVariant = 'default' | 'primary' | 'success' | 'warning' | 'danger' | 'info' | 'outline' | 'purple' | 'amber' | 'emerald' | 'sky';
...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const baseStyles = 'inline-flex items-center font-medium rounded-full whitespace-nowrap transition-colors select-none';
