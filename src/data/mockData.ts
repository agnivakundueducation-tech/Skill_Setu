...
export const ROLE_NAV_ITEMS: Record<UserRole, NavItem[]> = {
  student: [
    ...
    { label: 'Skill Interventions', path: '/dashboard/student/interventions', icon: 'Zap', badge: 'Active' },
  ...
  industry: [
    ...
    { label: 'Candidate Talent Pool', path: '/dashboard/industry/candidates', icon: 'Search', badge: 'Top 5%' },
    { label: 'Active Jobs & Openings', path: '/dashboard/industry/jobs', icon: 'Briefcase' },
    { label: 'Applications ATS', path: '/dashboard/industry/applications', icon: 'FileSpreadsheet', badge: 'Pipeline' },
    { label: 'Intern Cohorts & Mentors', path: '/dashboard/industry/cohorts', icon: 'GraduationCap', badge: 'Cohorts' },
    { label: 'Learning Programs', path: '/dashboard/industry/learning-programs', icon: 'BookOpenCheck', badge: 'Certificates' },
    { label: 'Academic Interventions', path: '/dashboard/industry/interventions', icon: 'Zap', badge: 'Active' },
    { label: 'Projects & Workshops', path: '/dashboard/industry/projects', icon: 'FileCode2', badge: 'Live' }
  ],
  academician: [
    { label: 'Collaboration Hub', path: '/dashboard/academician', icon: 'Building2', badge: 'Marketplace' },
    { label: 'My Collaborations', path: '/dashboard/academician/my-collaborations', icon: 'FileText', badge: 'Active' },
    ...
    { label: 'Cohort Interventions', path: '/dashboard/academician/cohorts', icon: 'Zap' }
  ],
  institution: [
    { label: 'Command Center', path: '/dashboard/institution', icon: 'LayoutDashboard' },
    { label: 'Intervention Engine', path: '/dashboard/institution/interventions', icon: 'Zap', badge: 'Closed-Loop' },
    { label: 'Faculty & Industry R&D', path: '/dashboard/institution/collaborations', icon: 'Building2', badge: 'Immersion' },
    { label: 'Demand vs Readiness', path: '/dashboard/institution/demand-readiness', icon: 'BarChart3', badge: '5 Core Skills' },
    { label: 'Competency Heatmaps', path: '/dashboard/institution/heatmaps', icon: 'Grid3X3' },
    { label: 'AI Curriculum Engine', path: '/dashboard/institution/ai-recommendations', icon: 'Lightbulb', badge: 'AI Blueprint' },
    { label: 'Placement & Internships', path: '/dashboard/institution/placements', icon: 'TrendingUp' },
    { label: 'Reports & Accreditation', path: '/dashboard/institution/reports', icon: 'FileText', badge: 'OBE' }
  ]
};
